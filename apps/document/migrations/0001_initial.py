    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('EMAIL', 'Електронна пошта'), ('SEV', 'СЕВОВВ'), ('LETTER', 'Лист')], default='LETTER', max_length=10, verbose_name='Джерело надходження')),
                ...
                ('mailing_method', models.CharField(choices=[('EMAIL', 'Електронна пошта'), ('SEV', 'СЕВОВВ'), ('LETTER', 'Лист')], default='LETTER', max_length=10, verbose_name='Спосіб відпралення')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_max_number', models.PositiveIntegerField(default=1, editable=False, verbose_name='Поточний максимальний номер')),
