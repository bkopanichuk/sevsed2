...
import apps.contracts.models.contract_product_model
import apps.contracts.models.dict_model
import apps.contracts.utils
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            bases=(apps.contracts.models.contract_product_model.ProductMixin, apps.l_core.mixins.CheckProtected, apps.l_core.mixins.RelatedObjects, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_period', models.DateField(default=apps.contracts.utils.default_end_period, verbose_name='Кінець дії тарифного плану')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edrpou', models.CharField(blank=True, db_index=True, max_length=50, null=True, verbose_name='ЄДРПОУ')),
                ...
                ('statute_copy', models.TextField(max_length=100, null=True, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf', 'doc', 'docx', 'jpg'])], verbose_name='Статутні документи')),
